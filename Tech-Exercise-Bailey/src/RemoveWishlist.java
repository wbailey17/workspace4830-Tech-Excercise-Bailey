...
public class RemoveWishlist extends HttpServlet {
    ...
    void remove(String keyword, HttpServletResponse response) throws IOException {
        ...
        String title = "Remove Book from Wishlist";
        ...
        if (!keyword.isEmpty()) {
        	try {
        		...
        		String selectSQL = "SELECT * FROM wishlist WHERE TITLE = ?";
	            ...
	            while (rs.next()) {
		            ...
		            selectSQL = "DELETE from wishlist where TITLE = ?";
		            preparedStatement = connection.prepareStatement(selectSQL);
		            preparedStatement.setString(1, theTitle);
      	...
      	out.println("</table>");
      	out.println("<a href=\\Tech-Exercise-Bailey\\selectList.html>Select List</a> <br>");
      	out.println("<a href=\\Tech-Exercise-Bailey\\removeWishlist.html>Remove Another Book</a> <br>");
      	out.println("</body></html>");
    }
