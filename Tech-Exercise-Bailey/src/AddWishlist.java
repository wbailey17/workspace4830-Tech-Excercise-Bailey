...
public class AddWishlist extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String insertSql = " INSERT INTO wishlist (id, TITLE, AUTHOR, GENRE) values (default, ?, ?, ?)";
        ...
        out.println(docType + //
              ...
              "  <li><b>Genre</b>: " + genre + "<br>"  //
        		);

        out.println("<br><a href=\\Tech-Exercise-Bailey\\addWishlistBook.html>Add Another Book</a> <br>");
